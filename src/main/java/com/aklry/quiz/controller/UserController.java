...
import com.aklry.quiz.model.dto.user.*;
import com.aklry.quiz.model.entity.User;
import com.aklry.quiz.model.vo.LoginUserVO;
...
import static com.aklry.quiz.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        if (StringUtils.isAnyBlank(userAccount, userPassword, checkPassword, userAvatar)) {
            return null;
        }
    ...
    public BaseResponse<Boolean> updateMyUser(@RequestBody UserUpdateMyRequest userUpdateMyRequest,
        ...
        if (StringUtils.isNotBlank(userPassword)) {
            ...
            userUpdateMyRequest.setUserPassword(encryptPassword);
        }
