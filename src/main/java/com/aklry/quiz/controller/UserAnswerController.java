...
import com.aklry.quiz.annotation.AuthCheck;
import com.aklry.quiz.common.BaseResponse;
import com.aklry.quiz.common.DeleteRequest;
...
import com.aklry.quiz.model.dto.userAnswer.UserAnswerAddRequest;
import com.aklry.quiz.model.dto.userAnswer.UserAnswerEditRequest;
import com.aklry.quiz.model.dto.userAnswer.UserAnswerQueryRequest;
import com.aklry.quiz.model.dto.userAnswer.UserAnswerUpdateRequest;
...
import com.aklry.quiz.model.vo.UserAnswerVO;
import com.aklry.quiz.scoring.ScoringStrategyExecutor;
import com.aklry.quiz.service.AppService;
import com.aklry.quiz.service.UserAnswerService;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "评分模块调用失败");
        }
    ...
    public BaseResponse<Boolean> editUserAnswer(@RequestBody UserAnswerEditRequest userAnswerEditRequest, HttpServletRequest request) {
        if (userAnswerEditRequest == null || userAnswerEditRequest.getAppId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        // 在此处将实体类和 DTO 进行转换
        UserAnswer userAnswer = new UserAnswer();
        ...
        User loginUser = userService.getLoginUser(request);
        // 判断是否存在
        long id = userAnswerEditRequest.getAppId();
        UserAnswer oldUserAnswer = userAnswerService.getById(id);
        ThrowUtils.throwIf(oldUserAnswer == null, ErrorCode.NOT_FOUND_ERROR);
        // 仅本人或管理员可编辑
