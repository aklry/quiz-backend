package com.aklry.quiz.model.vo;
...
public class ScoringResultVO implements Serializable {
    ...
    public static ScoringResult voToObj(ScoringResultVO scoringResultVO) {
        ...
        List<String> scoringResultVOResultProp = scoringResultVO.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(scoringResultVOResultProp));
